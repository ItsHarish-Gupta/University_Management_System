...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher(){
        ...
        labellblEmpId = new JLabel("23"+first4);
        labellblEmpId.setBounds(200,200,200,30);
        labellblEmpId.setFont(new Font("serif", Font.BOLD, 20));
        add(labellblEmpId);
        ...
        JLabel lblQlf = new JLabel("Qualification");
        lblQlf.setBounds(50,400,200,30);
        lblQlf.setFont(new Font("serif", Font.BOLD, 20));
        add(lblQlf);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == submit){
            ...
            String empid = labellblEmpId.getText();
            ...
            try{
                String query = "insert into teacher values ('"+name+"','"+fname+"', '"+empid+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+adhar+"', '"+qualification+"', '"+branch+"' )";
